...
\begin{table}[]
	...
	\end{center}
	\caption{\textbf{Table \ref{tab:categories}}.  \textbf{Categorisation of the meaning slots in the Indo-European example analysis used to display rate variation}.}
...
\begin{table}[]
	...
	\end{center}
	\caption{\textbf{Tab \ref{tab:langs}}.  \textbf{Languages in the Austronesian example analysis, including their ISO code and unique names as used by the Gray et. al. study and by WALS}.}
\label{tab:langs}
\end{table}
...
\begin{table}[ht]
	...
	\end{center}
	\caption{\textbf{Table \ref{tab:features}}.  \textbf{WALS features included in the Austronesian example analysis}.}
\label{tab:features}
\end{table}
